            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                <button
                  ...
                  className={`flex-1 rounded-pill py-2 font-display text-[13px] font-semibold flex items-center justify-center gap-2 ${recording ? "bg-marigolddark text-white" : "bg-slate text-white"
                    }`}
                >
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                {(["sarvam", "bhashini"] as const).map((e) => (
                  <button
                    key={e}
                    onClick={() => setEngine(e)}
                    className={`px-3 py-1 rounded-pill text-[11px] font-display border ${engine === e ? "bg-slate text-white border-slate" : "border-line text-inksoft bg-white"
                      }`}
                  >
